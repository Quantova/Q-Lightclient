...
pub fn seed_assets() -> Vec<Asset> {
    vec![
        ...
        Asset { origin_chain: 25, symbol: "USDT", tag: "qUSDT.sol" },
        Asset { origin_chain: 25, symbol: "SOL", tag: "qSOL.sol" },
        Asset { origin_chain: 25, symbol: "USDC", tag: "qUSDC.sol" },
        Asset { origin_chain: 25, symbol: "RENDER", tag: "qRENDER.sol" },
        Asset { origin_chain: 25, symbol: "BONK", tag: "qBONK.sol" },
        Asset { origin_chain: 25, symbol: "WIF", tag: "qWIF.sol" },
        Asset { origin_chain: 26, symbol: "USDT", tag: "qUSDT.tron" },
        Asset { origin_chain: 26, symbol: "TRX", tag: "qTRX.tron" },
        Asset { origin_chain: 26, symbol: "TUSD", tag: "qTUSD.tron" },
        Asset { origin_chain: 26, symbol: "XAUT", tag: "qXAUT.tron" },
